...
if case == 10:
    ...
    cgl = pyCQCGL1dSub(N, d, -0.1, 0.125, 0.5, 1, Bi, -0.1, Gi, -1)
    req, cp = CQCGLreq(cgl), CQCGLplot(cgl)

    a0, wth0, wphi0, err0 = req.read('../../data/cgl/reqBiGiEV.h5', req.toStr(Bi, Gi, 1))
    a0 = a0[:cgl.Ndim]
    aE = a0 + 0.01 * norm(a0) *  rand(cgl.Ndim)
    T = 200
