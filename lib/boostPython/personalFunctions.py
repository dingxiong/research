...
class KSplot():
    ...
    def readPO(self, fileName, poType, idx):
        f = h5py.File(fileName, 'r')
        po = '/' + poType + '/' + str(idx) + '/'
        a = f[po+'a'].value
        T = f[po+'T'].value
    ...
    def readFE(self, fileName, poType, idx):
        f = h5py.File(fileName, 'r')
        po = '/' + poType + '/' + str(idx) + '/'
        fe = f[po+'e'].value
        f.close()
    ...
    def readFV(self, fileName, poType, idx):
        f = h5py.File(fileName, 'r')
        po = '/' + poType + '/' + str(idx) + '/'
        fv = f[po+'ve'].value
        f.close()
    ...
    def readFEFV(self, fileName, poType, idx):
        f = h5py.File(fileName, 'r')
        po = '/' + poType + '/' + str(idx) + '/'
        fe = f[po+'e'].value
        fv = f[po+'ve'].value
