function [tt, uu, duu, hs, NReject, NevaCoe] = ETDRK4(L, NL, t0, u0, tend, h, skip_rate, ...
...
while t  < tend
    ...
    [unext, du] = oneStep(NL, E, E2, Q, b1, b2, b4, t, u, h);
...
function [unext, du] = oneStep(NL, E, E2, Q, b1, b2, b4, t, u, h)
    N1 = NL(t, u);
